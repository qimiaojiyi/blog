  ...
  <head>
    ...
    <div class="container">
        <form class="form-horizontal" method="post">
            <p class="block-heading">管理中心登录</p>
    ...
    <script>
        ...
        $('#checklogin').click(function(){
            var url = "<?php echo __APP__?>/manager/admin/checklogin",
            ...
            $.post(url,{'username':username,'password':password,'verifycode':verifycode},function(rs){
                if(rs == 'errorcode'){
                    alert('验证码不正确');
                }else if(rs == 'erroradmin'){
                    alert('用户名或密码错误');
                }else{
                    window.location.href="<?php echo __APP__?>/manager/ucenter/list";
                }
            });
        });
