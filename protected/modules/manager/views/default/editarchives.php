...
<ul class="breadcrumb">
    <li><a href="/">首页</a> > </li>
    <li><a href="<?php echo __APP__?>/manager/default/type">网站栏目管理</a> > <a href="<?php echo __APP__?>/manager/default/arclist?typeid=<?php echo $arcinfo['typeid']?>"></a> > 修改文档</li>
...
<!--添加文章层-->
    <div class="m_typebox">
        <form action="<?php echo __APP__?>/manager/default/editarchives" method="post" name="addform" enctype="multipart/form-data">
        <ul class="padding17">
            ...
            <p>
                文章内容：
                <script id="editor" name="ucontent" type="text/plain" style="width:90%;height:300px;margin-left: 74px;"><?php echo $arcinfo['description']?></script>
