...
<ul class="breadcrumb">
    <li><a href="/">首页</a> > </li>
    <li><a href="<?php echo __APP__?>/manager/type">网站栏目管理</a> > 栏目内容列表 【<?php echo $typename;?>】</li>
    <li style="position: absolute;right:17px;top:-3px;">
        <div class="btn-toolbar">
            <div class="btn-group">
                <a class="btn btn-mini" role="button" href="<?php echo __APP__?>/manager/addarchives?typeid=<?php echo $_GET['typeid']?>" data-toggle="modal">添加文档</a>
            </div>
        </div>
    </li>
</ul>
...
<div class='m_listwraper'>
    <div class="m_typebox">
        <ul class="padding17">
            <li style="height:25px;font-size: 14px;line-height: 25px;">
